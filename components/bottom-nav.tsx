...
export function BottomNav({ activeTab }: BottomNavProps) {
  return (
    <nav className="fixed inset-x-0 bottom-4 z-50 px-4 lg:hidden">
      <div className="mx-auto flex max-w-xl items-center justify-between rounded-full border border-[var(--border-default)] bg-[rgba(255,250,243,0.92)] px-2 py-2 shadow-[var(--shadow-large)] backdrop-blur">
        {items.map((item) => {
